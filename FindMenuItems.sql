...
INSERT INTO orders (order_id, order_date, quantity, total_cost, customer_id, staff_id, menu_id) VALUES
(1, '2025-01-01', 3, 200.00, 1, 1, 1),
(2, '2025-01-02', 4, 250.00, 2, 2, 2),
(3, '2025-01-03', 1, 100.00, 3, 3, 3),
(4, '2025-01-04', 5, 300.00, 4, 4, 4),
(5, '2025-01-05', 6, 350.00, 5, 5, 5),
(6, '2025-01-06', 2, 150.00, 6, 6, 6),
(7, '2025-01-07', 3, 220.00, 7, 7, 7),
(8, '2025-01-08', 4, 280.00, 8, 8, 8),
(9, '2025-01-09', 1, 110.00, 9, 9, 9),
(10, '2025-01-10', 5, 330.00, 10, 10, 10);
...
INSERT INTO menu (menu_id, menu_name, course, drink, dessert) VALUES
(1, 'Italian Pasta', 'Pasta', 'Wine', 'Tiramisu'),
(2, 'Mexican Tacos', 'Tacos', 'Margarita', 'Churros'),
(3, 'Indian Curry', 'Curry', 'Lassi', 'Gulab Jamun'),
(4, 'American Burger', 'Burger', 'Soda', 'Brownie'),
(5, 'Japanese Ramen', 'Ramen', 'Sake', 'Mochi'),
(6, 'Chinese Fried Rice', 'Fried Rice', 'Tea', 'Fortune Cookie'),
(7, 'French Coq au Vin', 'Coq au Vin', 'Champagne', 'Crème Brûlée'),
(8, 'Greek Gyro', 'Gyro', 'Ouzo', 'Baklava'),
(9, 'Spanish Paella', 'Paella', 'Sangria', 'Flan'),
(10, 'Lebanese Shawarma', 'Shawarma', 'Arak', 'Baklava');
...
-- Final Query to find all menu items for which more than 2 orders have been placed
SELECT course AS "MenuName"
FROM menu
WHERE menu_id = ANY (
    SELECT menu_id
    FROM ordermenu
